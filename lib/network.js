...
export class Network {
   ...
   *
   * @example <caption>Creating a Network net and adding 2 nodes and an edge between them.</caption>
   ...
   *
   * @param  {Object} obj
   * @param  {number|string} obj.id   description
   * @param  {number} [obj.weight=1]  description
   */
  addNode ({ id, weight = 1 } = {}) {
